...
<div class="flex flex-col gap-6">
    <div>
        ...
        <p class="text-gray-400">Thời lượng: {{ $assignment->duration }} phút</p>
        <p class="text-gray-400">Hạn nộp: {{ $assignment->due_date?->format('d/m/Y H:i') }}</p>
    </div>

    <form method="POST" action="{{ route('student.assignments.submit', $assignment) }}" class="space-y-4">
        @csrf
