            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    @auth
                        ...
                        <!-- Message Icon -->
                        <a href="{{ route('messages.index') }}" class="relative inline-flex items-center justify-center w-9 h-9 rounded-full bg-gray-700 text-white hover:bg-purple-600 transition" title="Tin nhắn" aria-label="Tin nhắn">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                        ...
                        <!-- Group Message Icon -->
                        <a href="{{ route('group_messages.index') }}" class="relative inline-flex items-center justify-center w-9 h-9 rounded-full bg-gray-700 text-white hover:bg-purple-600 transition" title="Nhóm chat khóa học" aria-label="Nhóm chat khóa học">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
